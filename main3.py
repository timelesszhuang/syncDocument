...
if __name__ == '__main__':
    js = sendRequest("http://img.jiaoyuxueli.cn/api/?act=act3&t=1&sn=f9be311e65d81a9ad8150a60844bb94c", {})
    if js != None:
        pass
    print(js)
    id = js['id']
    fromfilelist = js['from']
    todir = js['to']
    FilesToZip(fromfilelist, todir)
    # 删除文件
    # for file in fromfilelist:
    #     os.remove(file)
    sendRequest("http://img.jiaoyuxueli.cn/api/?act=act3up&t=1&sn=f9be311e65d81a9ad8150a60844bb94c", {'id': id})
